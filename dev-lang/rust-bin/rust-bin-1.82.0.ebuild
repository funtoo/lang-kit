...
SRC_URI="
		abi_x86_64? ( 
		https://static.rust-lang.org/dist/rust-1.82.0-x86_64-unknown-linux-gnu.tar.xz -> rust-1.82.0-x86_64-unknown-linux-gnu.tar.xz
	)
	arm? ( 
		https://static.rust-lang.org/dist/rust-1.82.0-arm-unknown-linux-gnueabi.tar.xz -> rust-1.82.0-arm-unknown-linux-gnueabi.tar.xz
		https://static.rust-lang.org/dist/rust-1.82.0-arm-unknown-linux-gnueabihf.tar.xz -> rust-1.82.0-arm-unknown-linux-gnueabihf.tar.xz
		https://static.rust-lang.org/dist/rust-1.82.0-armv7-unknown-linux-gnueabihf.tar.xz -> rust-1.82.0-armv7-unknown-linux-gnueabihf.tar.xz
	)
	arm64? ( 
		https://static.rust-lang.org/dist/rust-1.82.0-aarch64-unknown-linux-gnu.tar.xz -> rust-1.82.0-aarch64-unknown-linux-gnu.tar.xz
	)
	riscv64? ( 
		https://static.rust-lang.org/dist/rust-1.82.0-riscv64gc-unknown-linux-gnu.tar.xz -> rust-1.82.0-riscv64gc-unknown-linux-gnu.tar.xz
	)
	rust-src? (
		https://static.rust-lang.org/dist/rust-src-1.82.0.tar.xz -> rust-src-1.82.0.tar.xz
	)
	wasm? (
		https://static.rust-lang.org/dist/rust-std-1.82.0-wasm32-unknown-unknown.tar.xz -> rust-std-1.82.0-wasm32-unknown-unknown.tar.xz
	)
	wasm-wasi? (
		https://static.rust-lang.org/dist/rust-std-1.82.0-wasm32-wasi.tar.xz -> rust-std-1.82.0-wasm32-wasi.tar.xz
	)
"
...
src_unpack() {
	...
	mv "${WORKDIR}/${MY_P}-$(rust_abi)" "${S}" || die
		if use rust-src; then
				mv "${WORKDIR}/rust-src-1.82.0/rust-src" "${S}"/rust-src
		fi
		if use wasm; then
				mv "${WORKDIR}/rust-std-1.82.0-wasm32-unknown-unknown/rust-std-wasm32-unknown-unknown" "${S}"/rust-std-wasm32-unknown-unknown
		fi
		if use wasm-wasi; then
				mv "${WORKDIR}/rust-std-1.82.0-wasm32-wasi/rust-std-wasm32-wasi" "${S}"/rust-std-wasm32-wasi
		fi
}
